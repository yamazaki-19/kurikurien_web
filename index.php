...
<body>
    <div class="kv">
        ...
        <img class="mv_bg" src="./image/mv.png" alt="栗の収穫シーン" width="1440" height="840" />
        <header>
            <div class="header_inner">
                <h1 class="logo">
                    <a href="#concept"><img src="./image/logo.png" alt="くりくり園のロゴ" width="90" height="95" /></a>
                </h1>
                <!-- ハンバーガーメニューのボタン -->
    ...
    <section class="blog_section" id="blog">
        ...
        <div class="blog_container">
            ...
            <div class="blog_img_container">
                <img src="./image/mountain_white.png" alt="山のイラスト" width="686" height="172">
            </div>
        </div>
    </section>
    <!-- ここまでブログ -->
    ...
    <section class="concept_section" id="concept">
        <div class="concept_container">
            ...
            <div class="concept_main">
                ...
                <img class="concept_logo" src="./image/logo.png" alt="たこまんファームプロジェクトロゴ" width="255" height="270" />
        ...
        <div class="concept_columns">
            ...
            <img src="./image/cycle.png" alt="たこまんファームプトジェクトにて発生する地域の循環図" width="517" height="517" />
        </div>
        <img class="concept_img" src="./image/kurikurien.png" alt="栗の木" width="1440" height="620" />
        <div class="concept_text_container">
            <p class="concept_text">
                ...
                自社農園として運営をすることで、後継者不足の解消のみならず、収穫から加工までのリーチタイムが短くなり、新鮮かつ安心安全な品質で<br />
                お届けできるというメリットも。<br />
        ...
        <div class="industry_container">
            ...
            <div class="industry_main">
                <div class="image_block">
                    <img class="industry_img" src="./image/minori_mv.png" alt="掛川栗を使った秋限定モンブラン" width="1080" height="717" />
                    <div class="white_box">
                ...
                <div class="image_block">
                    <img class="industry_img" src="./image/daisakyu_mv.png" alt="掛川栗を使った秋限定ブッセ" width="1080" height="717" />
                    <div class="white_box">
    ...
    <!-- ここまでお菓子たち -->
    <img class="instagram_img" src="./image/tree_green.png" alt="木のイラスト" width="183" height="201">
    <!-- ここからインスタグラム -->
    <section class="instagram_section" id="instagram">
        <div class="instagram_container">
            ...
            <div class="instagram_posts">
                ...
                <div class="embed">
                    <blockquote class="instagram-media"
                        data-instgrm-permalink="https://www.instagram.com/p/DFKSLvSSQcf/?utm_source=ig_embed&amp;utm_campaign=loading"
                        data-instgrm-version="14"
                        style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                        <div style="padding:16px;"> <a
                                href="https://www.instagram.com/p/DFKSLvSSQcf/?utm_source=ig_embed&amp;utm_campaign=loading"
                                style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;"
                                target="_blank">
                                <div style=" display: flex; flex-direction: row; align-items: center;">
                                    <div
                            ...
                            <p
                                style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                                <a href="https://www.instagram.com/p/DFKSLvSSQcf/?utm_source=ig_embed&amp;utm_campaign=loading"
                                    style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
                                    target="_blank">たこまんファームプロジェクト(@takoman_farm)がシェアした投稿</a>
                            </p>
                        </div>
    ...
    <!-- ここから公式サイトボタン -->
    <section class="co_hp">
        <a href="https://www.takoman.co.jp/" target="_blank" rel="noopener noreferrer"><img src="./image/takoman-logo.png" alt="" width="325" height="73">
            <p>オフィシャルサイトはこちら</p>
        </a>
    </section>
    <!-- ここまで公式サイトボタン -->
